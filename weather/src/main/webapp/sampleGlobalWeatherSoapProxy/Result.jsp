...
<%
        ...
        String tempResultreturnp3 = String.valueOf(getEndpoint2mtemp);
        %>
        <%= tempResultreturnp3 %>
        <%
}
...
<%
        ...
        String tempResultreturnp14 = String.valueOf(getWeather13mtemp);
        %>
        <%= tempResultreturnp14 %>
        <%
}
...
<%
        ...
        String tempResultreturnp21 = String.valueOf(getCitiesByCountry20mtemp);
        %>
        <%= tempResultreturnp21 %>
        <%
}
